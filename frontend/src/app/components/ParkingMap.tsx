...
import { Car, Navigation, ArrowLeft, Info } from 'lucide-react';
          ...
          <CardContent className="p-8">
            <div className="grid grid-cols-5 md:grid-cols-10 gap-3 max-w-5xl mx-auto">
              {(zonesData[selectedZone] || []).map((slot) => (
                <div 
                  key={slot.id}
                  className={`relative h-16 border-2 rounded-md flex flex-col items-center justify-center transition-all
